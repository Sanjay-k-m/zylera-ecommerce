...
const NoProductsAvailable = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center py-10 min-h-80 space-y-4 text-center bg-gray-100 rounded-lg w-full"
      )}
    >
      <motion.div
      ...
      >
        ...
        <span className="text-base font-semibold text-custom-darkColor">
          {selectedTab}
        </span>
